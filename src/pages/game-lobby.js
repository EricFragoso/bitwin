...
function GameLobby() {
    return(
        <div id="S2-CASUAL" className="flex flex-col sm:flex-row w-full h-screen items-center content-center bg-purple-800">
            ...
            <div id="game" className="text-center w-3/6 mx-auto border-4 border-purple-500 bg-purple-700 shadow-xl px-10 py-10 rounded-3xl">
